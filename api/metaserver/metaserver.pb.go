...
const file_api_metaserver_metaserver_proto_rawDesc = "" +
	...
	"\tHeartbeat\x12\x1c.metaserver.HeartbeatRequest\x1a\x1d.metaserver.HeartbeatResponseB/Z-github.com/umangshikarvar/dvfs/api/metaserverb\x06proto3"
...
var file_api_metaserver_metaserver_proto_goTypes = []any{
	...
	(*HeartbeatRequest)(nil),           // 4: metaserver.HeartbeatRequest
	(*HeartbeatResponse)(nil),          // 5: metaserver.HeartbeatResponse
}
var file_api_metaserver_metaserver_proto_depIdxs = []int32{
	...
	4, // 2: metaserver.MetaServer.Heartbeat:input_type -> metaserver.HeartbeatRequest
	...
	5, // 5: metaserver.MetaServer.Heartbeat:output_type -> metaserver.HeartbeatResponse
