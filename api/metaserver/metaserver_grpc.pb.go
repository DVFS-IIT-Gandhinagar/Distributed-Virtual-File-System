...
const (
	...
	MetaServer_Heartbeat_FullMethodName                  = "/metaserver.MetaServer/Heartbeat"
	...
	MetaServer_GetTrustBundle_FullMethodName             = "/metaserver.MetaServer/GetTrustBundle"
	MetaServer_IssueFileServerCertificate_FullMethodName = "/metaserver.MetaServer/IssueFileServerCertificate"
)
...
type MetaServerClient interface {
	...
	IssueFileServerCertificate(ctx context.Context, in *IssueFileServerCertificateRequest, opts ...grpc.CallOption) (*IssueFileServerCertificateResponse, error)
}
...
func (c *metaServerClient) Heartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*HeartbeatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HeartbeatResponse)
	err := c.cc.Invoke(ctx, MetaServer_Heartbeat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metaServerClient) GetTrustBundle(ctx context.Context, in *GetTrustBundleRequest, opts ...grpc.CallOption) (*GetTrustBundleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTrustBundleResponse)
	err := c.cc.Invoke(ctx, MetaServer_GetTrustBundle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metaServerClient) IssueFileServerCertificate(ctx context.Context, in *IssueFileServerCertificateRequest, opts ...grpc.CallOption) (*IssueFileServerCertificateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IssueFileServerCertificateResponse)
	err := c.cc.Invoke(ctx, MetaServer_IssueFileServerCertificate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetaServerServer interface {
	...
	IssueFileServerCertificate(context.Context, *IssueFileServerCertificateRequest) (*IssueFileServerCertificateResponse, error)
...
func (UnimplementedMetaServerServer) Heartbeat(context.Context, *HeartbeatRequest) (*HeartbeatResponse, error) {
...
func (UnimplementedMetaServerServer) GetTrustBundle(context.Context, *GetTrustBundleRequest) (*GetTrustBundleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTrustBundle not implemented")
}
func (UnimplementedMetaServerServer) IssueFileServerCertificate(context.Context, *IssueFileServerCertificateRequest) (*IssueFileServerCertificateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IssueFileServerCertificate not implemented")
}
...
func _MetaServer_Heartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HeartbeatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetaServerServer).Heartbeat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetaServer_Heartbeat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetaServerServer).Heartbeat(ctx, req.(*HeartbeatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MetaServer_GetTrustBundle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTrustBundleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetaServerServer).GetTrustBundle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetaServer_GetTrustBundle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetaServerServer).GetTrustBundle(ctx, req.(*GetTrustBundleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MetaServer_IssueFileServerCertificate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IssueFileServerCertificateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetaServerServer).IssueFileServerCertificate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetaServer_IssueFileServerCertificate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetaServerServer).IssueFileServerCertificate(ctx, req.(*IssueFileServerCertificateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MetaServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MetaServer_Heartbeat_Handler,
		},
		{
			MethodName: "GetRoots",
		...
		},
		{
			...
			Handler:    _MetaServer_GetTrustBundle_Handler,
		},
		{
			MethodName: "IssueFileServerCertificate",
			Handler:    _MetaServer_IssueFileServerCertificate_Handler,
		},
	},
