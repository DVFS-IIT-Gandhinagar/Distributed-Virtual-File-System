...
const file_api_fileserver_fileserver_proto_rawDesc = "" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12#\n" +
	"\rrestored_name\x18\x03 \x01(\tR\frestoredName\"3\n" +
	...
	"\vRestoreFile\x12\x1e.fileserver.RestoreFileRequest\x1a\x1f.fileserver.RestoreFileResponse\x12B\n" +
...
var file_api_fileserver_fileserver_proto_goTypes = []any{
	...
	(*GetAttrRequest)(nil),         // 19: fileserver.GetAttrRequest
	(*GetAttrResponse)(nil),        // 20: fileserver.GetAttrResponse
	(*PathRequest)(nil),            // 21: fileserver.PathRequest
	(*PathResponse)(nil),           // 22: fileserver.PathResponse
	(*ChangeDirRequest)(nil),       // 23: fileserver.ChangeDirRequest
	(*ChangeDirResponse)(nil),      // 24: fileserver.ChangeDirResponse
	(*ListDirRequest)(nil),         // 25: fileserver.ListDirRequest
	(*DirEntry)(nil),               // 26: fileserver.DirEntry
	(*ListDirResponse)(nil),        // 27: fileserver.ListDirResponse
	(*LookupRequest)(nil),          // 28: fileserver.LookupRequest
	(*LookupResponse)(nil),         // 29: fileserver.LookupResponse
	(*UploadFileRequest)(nil),      // 30: fileserver.UploadFileRequest
	(*UploadFileResponse)(nil),     // 31: fileserver.UploadFileResponse
	(*DownloadFileRequest)(nil),    // 32: fileserver.DownloadFileRequest
...
var file_api_fileserver_fileserver_proto_depIdxs = []int32{
	...
	1,  // 10: fileserver.GetAttrRequest.fid:type_name -> fileserver.FID
	0,  // 11: fileserver.GetAttrResponse.type:type_name -> fileserver.InodeType
	1,  // 12: fileserver.PathRequest.fid:type_name -> fileserver.FID
	1,  // 13: fileserver.ChangeDirRequest.fid:type_name -> fileserver.FID
	1,  // 14: fileserver.ChangeDirRequest.root_fid:type_name -> fileserver.FID
	1,  // 15: fileserver.ChangeDirResponse.new_fid:type_name -> fileserver.FID
	1,  // 16: fileserver.ListDirRequest.fid:type_name -> fileserver.FID
	1,  // 17: fileserver.DirEntry.fid:type_name -> fileserver.FID
	0,  // 18: fileserver.DirEntry.type:type_name -> fileserver.InodeType
	26, // 19: fileserver.ListDirResponse.entries:type_name -> fileserver.DirEntry
	1,  // 20: fileserver.LookupRequest.parent_fid:type_name -> fileserver.FID
	1,  // 21: fileserver.LookupResponse.fid:type_name -> fileserver.FID
	...
	1,  // 24: fileserver.ShareRequest.fid:type_name -> fileserver.FID
	1,  // 25: fileserver.UnshareRequest.fid:type_name -> fileserver.FID
	1,  // 26: fileserver.RegisterClientResponse.user_root_fid:type_name -> fileserver.FID
	38, // 27: fileserver.FileServer.RegisterClient:input_type -> fileserver.RegisterClientRequest
	3,  // 28: fileserver.FileServer.CreateFile:input_type -> fileserver.CreateFileRequest
	5,  // 29: fileserver.FileServer.OpenFile:input_type -> fileserver.OpenFileRequest
	7,  // 30: fileserver.FileServer.ReadFile:input_type -> fileserver.ReadFileRequest
	9,  // 31: fileserver.FileServer.WriteFile:input_type -> fileserver.WriteFileRequest
	11, // 32: fileserver.FileServer.CloseFile:input_type -> fileserver.CloseFileRequest
	13, // 33: fileserver.FileServer.DeleteFile:input_type -> fileserver.DeleteFileRequest
	15, // 34: fileserver.FileServer.TrashFile:input_type -> fileserver.TrashFileRequest
	17, // 35: fileserver.FileServer.RestoreFile:input_type -> fileserver.RestoreFileRequest
	19, // 36: fileserver.FileServer.GetAttr:input_type -> fileserver.GetAttrRequest
	25, // 37: fileserver.FileServer.ListDir:input_type -> fileserver.ListDirRequest
	28, // 38: fileserver.FileServer.Lookup:input_type -> fileserver.LookupRequest
	21, // 39: fileserver.FileServer.Path:input_type -> fileserver.PathRequest
	23, // 40: fileserver.FileServer.ChangeDir:input_type -> fileserver.ChangeDirRequest
	30, // 41: fileserver.FileServer.UploadFile:input_type -> fileserver.UploadFileRequest
	32, // 42: fileserver.FileServer.DownloadFile:input_type -> fileserver.DownloadFileRequest
	34, // 43: fileserver.FileServer.Share:input_type -> fileserver.ShareRequest
	36, // 44: fileserver.FileServer.Unshare:input_type -> fileserver.UnshareRequest
	39, // 45: fileserver.FileServer.RegisterClient:output_type -> fileserver.RegisterClientResponse
	4,  // 46: fileserver.FileServer.CreateFile:output_type -> fileserver.CreateFileResponse
	6,  // 47: fileserver.FileServer.OpenFile:output_type -> fileserver.OpenFileResponse
	8,  // 48: fileserver.FileServer.ReadFile:output_type -> fileserver.ReadFileResponse
	10, // 49: fileserver.FileServer.WriteFile:output_type -> fileserver.WriteFileResponse
	12, // 50: fileserver.FileServer.CloseFile:output_type -> fileserver.CloseFileResponse
	14, // 51: fileserver.FileServer.DeleteFile:output_type -> fileserver.DeleteFileResponse
	16, // 52: fileserver.FileServer.TrashFile:output_type -> fileserver.TrashFileResponse
	18, // 53: fileserver.FileServer.RestoreFile:output_type -> fileserver.RestoreFileResponse
	20, // 54: fileserver.FileServer.GetAttr:output_type -> fileserver.GetAttrResponse
	27, // 55: fileserver.FileServer.ListDir:output_type -> fileserver.ListDirResponse
	29, // 56: fileserver.FileServer.Lookup:output_type -> fileserver.LookupResponse
	22, // 57: fileserver.FileServer.Path:output_type -> fileserver.PathResponse
	24, // 58: fileserver.FileServer.ChangeDir:output_type -> fileserver.ChangeDirResponse
	31, // 59: fileserver.FileServer.UploadFile:output_type -> fileserver.UploadFileResponse
	33, // 60: fileserver.FileServer.DownloadFile:output_type -> fileserver.DownloadFileResponse
	35, // 61: fileserver.FileServer.Share:output_type -> fileserver.ShareResponse
	37, // 62: fileserver.FileServer.Unshare:output_type -> fileserver.UnshareResponse
