...
type DeleteFileRequest struct {
	...
	Fid           *FID                   `protobuf:"bytes,1,opt,name=fid,proto3" json:"fid,omitempty"`
	User          string                 `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"`
	Recursive     bool                   `protobuf:"varint,3,opt,name=recursive,proto3" json:"recursive,omitempty"` // if true, allows deletion of non-empty directories
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TrashFileRequest struct {
	...
	Fid           *FID                   `protobuf:"bytes,1,opt,name=fid,proto3" json:"fid,omitempty"`
	User          string                 `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"`
	Recursive     bool                   `protobuf:"varint,3,opt,name=recursive,proto3" json:"recursive,omitempty"` // if true, allows trashing non-empty directories
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TrashFileRequest) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *RestoreFileRequest) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
const file_api_fileserver_fileserver_proto_rawDesc = "" +
	...
	"\x03fid\x18\x03 \x01(\v2\x0f.fileserver.FIDR\x03fid\x12)\n" +
	...
	"\aversion\x18\x04 \x01(\x04R\aversion\"\x98\x01\n" +
	...
	"\x04user\x18\x05 \x01(\tR\x04user\"V\n" +
	...
	"\trecursive\x18\x03 \x01(\bR\trecursive\"D\n" +
	...
	"\ftrashed_name\x18\x03 \x01(\tR\vtrashedName\"K\n" +
	"\x12RestoreFileRequest\x12!\n" +
	"\x03fid\x18\x01 \x01(\v2\x0f.fileserver.FIDR\x03fid\x12\x12\n" +
	"\x04user\x18\x02 \x01(\tR\x04user\"j\n" +
	"\x13RestoreFileResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12#\n" +
	"\rrestored_name\x18\x03 \x01(\tR\frestoredName\"G\n" +
	...
	"\aversion\x18\x06 \x01(\x04R\aversion\"D\n" +
	"\vPathRequest\x12!\n" +
	"\x03fid\x18\x01 \x01(\v2\x0f.fileserver.FIDR\x03fid\x12\x12\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12(\n" +
	"\anew_fid\x18\x03 \x01(\v2\x0f.fileserver.FIDR\x06newFid\"G\n" +
	"\x0eListDirRequest\x12!\n" +
	"\x03fid\x18\x01 \x01(\v2\x0f.fileserver.FIDR\x03fid\x12\x12\n" +
	"\x04user\x18\x02 \x01(\tR\x04user\"\x80\x01\n" +
	"\bDirEntry\x12!\n" +
	"\x03fid\x18\x01 \x01(\v2\x0f.fileserver.FIDR\x03fid\x12\x12\n" +
...
var file_api_fileserver_fileserver_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_api_fileserver_fileserver_proto_goTypes = []any{
	...
	(*RegisterClientRequest)(nil),  // 34: fileserver.RegisterClientRequest
	(*RegisterClientResponse)(nil), // 35: fileserver.RegisterClientResponse
}
var file_api_fileserver_fileserver_proto_depIdxs = []int32{
	...
	34, // 25: fileserver.FileServer.RegisterClient:input_type -> fileserver.RegisterClientRequest
	...
	9,  // 29: fileserver.FileServer.WriteFile:input_type -> fileserver.WriteFileRequest
	11, // 30: fileserver.FileServer.CloseFile:input_type -> fileserver.CloseFileRequest
	13, // 31: fileserver.FileServer.DeleteFile:input_type -> fileserver.DeleteFileRequest
	15, // 32: fileserver.FileServer.TrashFile:input_type -> fileserver.TrashFileRequest
	17, // 33: fileserver.FileServer.RestoreFile:input_type -> fileserver.RestoreFileRequest
	19, // 34: fileserver.FileServer.GetAttr:input_type -> fileserver.GetAttrRequest
	25, // 35: fileserver.FileServer.ListDir:input_type -> fileserver.ListDirRequest
	28, // 36: fileserver.FileServer.Lookup:input_type -> fileserver.LookupRequest
	21, // 37: fileserver.FileServer.Path:input_type -> fileserver.PathRequest
	23, // 38: fileserver.FileServer.ChangeDir:input_type -> fileserver.ChangeDirRequest
	...
	35, // 41: fileserver.FileServer.RegisterClient:output_type -> fileserver.RegisterClientResponse
	4,  // 42: fileserver.FileServer.CreateFile:output_type -> fileserver.CreateFileResponse
	6,  // 43: fileserver.FileServer.OpenFile:output_type -> fileserver.OpenFileResponse
	8,  // 44: fileserver.FileServer.ReadFile:output_type -> fileserver.ReadFileResponse
	10, // 45: fileserver.FileServer.WriteFile:output_type -> fileserver.WriteFileResponse
	12, // 46: fileserver.FileServer.CloseFile:output_type -> fileserver.CloseFileResponse
	14, // 47: fileserver.FileServer.DeleteFile:output_type -> fileserver.DeleteFileResponse
	16, // 48: fileserver.FileServer.TrashFile:output_type -> fileserver.TrashFileResponse
	18, // 49: fileserver.FileServer.RestoreFile:output_type -> fileserver.RestoreFileResponse
	20, // 50: fileserver.FileServer.GetAttr:output_type -> fileserver.GetAttrResponse
	27, // 51: fileserver.FileServer.ListDir:output_type -> fileserver.ListDirResponse
	29, // 52: fileserver.FileServer.Lookup:output_type -> fileserver.LookupResponse
	22, // 53: fileserver.FileServer.Path:output_type -> fileserver.PathResponse
	24, // 54: fileserver.FileServer.ChangeDir:output_type -> fileserver.ChangeDirResponse
	31, // 55: fileserver.FileServer.UploadFile:output_type -> fileserver.UploadFileResponse
	33, // 56: fileserver.FileServer.DownloadFile:output_type -> fileserver.DownloadFileResponse
