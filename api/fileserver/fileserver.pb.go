...
const file_api_fileserver_fileserver_proto_rawDesc = "" +
	...
	"\troot_user\x18\x04 \x01(\tR\brootUser\"g\n" +
	...
	"\aUnshare\x12\x1a.fileserver.UnshareRequest\x1a\x1b.fileserver.UnshareResponseBPZNgithub.com/DVFS-IIT-Gandhinagar/Distributed-Virtual-File-System/api/fileserverb\x06proto3"
...
var file_api_fileserver_fileserver_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
...
var file_api_fileserver_fileserver_proto_depIdxs = []int32{
	...
	41, // 47: fileserver.FileServer.RegisterClient:output_type -> fileserver.RegisterClientResponse
	4,  // 48: fileserver.FileServer.CreateFile:output_type -> fileserver.CreateFileResponse
	6,  // 49: fileserver.FileServer.OpenFile:output_type -> fileserver.OpenFileResponse
	8,  // 50: fileserver.FileServer.ReadFile:output_type -> fileserver.ReadFileResponse
	10, // 51: fileserver.FileServer.WriteFile:output_type -> fileserver.WriteFileResponse
	12, // 52: fileserver.FileServer.CloseFile:output_type -> fileserver.CloseFileResponse
	14, // 53: fileserver.FileServer.DeleteFile:output_type -> fileserver.DeleteFileResponse
	16, // 54: fileserver.FileServer.TrashFile:output_type -> fileserver.TrashFileResponse
	18, // 55: fileserver.FileServer.RestoreFile:output_type -> fileserver.RestoreFileResponse
	20, // 56: fileserver.FileServer.ShowTrash:output_type -> fileserver.ShowTrashResponse
	22, // 57: fileserver.FileServer.GetAttr:output_type -> fileserver.GetAttrResponse
	29, // 58: fileserver.FileServer.ListDir:output_type -> fileserver.ListDirResponse
	31, // 59: fileserver.FileServer.Lookup:output_type -> fileserver.LookupResponse
	24, // 60: fileserver.FileServer.Path:output_type -> fileserver.PathResponse
	26, // 61: fileserver.FileServer.ChangeDir:output_type -> fileserver.ChangeDirResponse
	33, // 62: fileserver.FileServer.UploadFile:output_type -> fileserver.UploadFileResponse
	35, // 63: fileserver.FileServer.DownloadFile:output_type -> fileserver.DownloadFileResponse
	37, // 64: fileserver.FileServer.Share:output_type -> fileserver.ShareResponse
	39, // 65: fileserver.FileServer.Unshare:output_type -> fileserver.UnshareResponse
